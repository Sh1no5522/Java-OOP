...
# Initialize pygame
pygame.init()
background = pygame.image.load(r"C:\Users\Sh1nO\Downloads\photo_2025-04-05_18-53-40.jpg")
# Game constants
...
pygame.mixer.music.load(r"C:\Users\Sh1nO\Documents\Programming\python\Python\lab_9\racer2\Lab 8_racer_background.wav")
...
class Enemy(Entity):
    """Enemy car class"""
    def __init__(self):
        super().__init__(r"C:\Users\Sh1nO\Documents\Programming\python\Python\lab_9\racer2\Enemy.png", (random.randint(40, SCREEN_WIDTH - 40), 0))
...
class Player(Entity):
    ...
    def __init__(self):
        super().__init__(r"C:\Users\Sh1nO\Documents\Programming\python\Python\lab_9\racer2\Player.png", (160, 520))
...
class Coin(Entity):
    ...
    def __init__(self):
        super().__init__(r"C:\Users\Sh1nO\Documents\Programming\python\Python\lab_9\racer2\coin2.png", (random.randint(30, SCREEN_WIDTH - 30), 0))
